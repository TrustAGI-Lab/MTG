...
public final class MathUtils
  ...
  public static /*@pure@*/ int[] stableSort(double[] array){
    ...
    while (i < index.length) {
      numEqual = 1;
      for (int j = i+1; ((j < index.length) && MathUtils.eq(array[index[i]],
							array[index[j]])); j++)
	numEqual++;
      if (numEqual > 1) {
	helpIndex = new int[numEqual];
  ...
  public static /*@pure@*/ double xlogx(int c) {
    ...
    return c * MathUtils.log2((double) c);
  }
  ...
  public static void main(String[] ops) {
    ...
    try {
      ...
      if (ops.length > 0) {
	String[] firstOptionSplitUp = MathUtils.splitOptions(ops[0]);
	for (int i = 0; i < firstOptionSplitUp.length; i ++) {
	  System.out.println(firstOptionSplitUp[i]);
	}
      }					       
      System.out.println("Partitioned options: ");
      String[] partitionedOptions = MathUtils.partitionOptions(ops);
      for (int i  = 0; i < partitionedOptions.length; i++) {
	System.out.println(partitionedOptions[i]);
      }
      System.out.println("Get position of flag -f: " + MathUtils.getOptionPos('f', ops));
      System.out.println("Get flag -f: " + MathUtils.getFlag('f', ops));
      System.out.println("Get position of option -o: " + MathUtils.getOptionPos('o', ops));
      System.out.println("Get option -o: " + MathUtils.getOption('o', ops));
      System.out.println("Checking for remaining options... ");
      MathUtils.checkForRemainingOptions(ops);
	...
	System.out.print(ints[i] + " ");
      ...
      System.out.println();
      System.out.println("Correlation: " + MathUtils.correlation(doubles, doubles, 
							     doubles.length));
      System.out.println("Mean: " + MathUtils.mean(doubles));
      System.out.println("Variance: " + MathUtils.variance(doubles));
      System.out.println("Sum (doubles): " + MathUtils.sum(doubles));
      System.out.println("Sum (ints): " + MathUtils.sum(ints));
      System.out.println("Max index (doubles): " + MathUtils.maxIndex(doubles));
      System.out.println("Max index (ints): " + MathUtils.maxIndex(ints));
      System.out.println("Min index (doubles): " + MathUtils.minIndex(doubles));
      System.out.println("Min index (ints): " + MathUtils.minIndex(ints));
      System.out.println("Median (doubles): " + 
                         MathUtils.kthSmallestValue(doubles, doubles.length / 2));
      System.out.println("Median (ints): " + 
                         MathUtils.kthSmallestValue(ints, ints.length / 2));

      // Sorting and normalizing
      System.out.println("Sorted array with NaN (doubles): ");
      int[] sorted = MathUtils.sort(doublesWithNaN);
      for (int i = 0; i < doublesWithNaN.length; i++) {
	System.out.print(doublesWithNaN[sorted[i]] + " ");
      }
      System.out.println();
      System.out.println("Sorted array (doubles): ");
      sorted = MathUtils.sort(doubles);
      for (int i = 0; i < doubles.length; i++) {
	System.out.print(doubles[sorted[i]] + " ");
      }
      System.out.println();
      System.out.println("Sorted array (ints): ");
      sorted = MathUtils.sort(ints);
      for (int i = 0; i < ints.length; i++) {
	System.out.print(ints[sorted[i]] + " ");
      }
      System.out.println();
      System.out.println("Indices from stable sort (doubles): ");
      sorted = MathUtils.stableSort(doubles);
      for (int i = 0; i < doubles.length; i++) {
	...
	System.out.print(doubles[i] + " ");
      ...
      // Pretty-printing
      System.out.println("-4.58: " + MathUtils.doubleToString(-4.57826535, 2));
      System.out.println("-6.78: " + MathUtils.doubleToString(-6.78214234, 6,2));
      
      // Comparisons
      System.out.println("5.70001 == 5.7 ? " + MathUtils.eq(5.70001, 5.7));
      System.out.println("5.70001 > 5.7 ? " + MathUtils.gr(5.70001, 5.7));
      System.out.println("5.70001 >= 5.7 ? " + MathUtils.grOrEq(5.70001, 5.7));
      System.out.println("5.7 < 5.70001 ? " + MathUtils.sm(5.7, 5.70001));
      System.out.println("5.7 <= 5.70001 ? " + MathUtils.smOrEq(5.7, 5.70001));
      
      // Math
      System.out.println("Info (ints): " + MathUtils.info(ints));
      System.out.println("log2(4.6): " + MathUtils.log2(4.6));
      System.out.println("5 * log(5): " + MathUtils.xlogx(5));
      System.out.println("5.5 rounded: " + MathUtils.round(5.5));
      System.out.println("5.55555 rounded to 2 decimal places: " + 
			 MathUtils.roundDouble(5.55555, 2));
      
      // Arrays
      System.out.println("Array-Dimensions of 'new int[][]': " + MathUtils.getArrayDimensions(new int[][]{}));
      System.out.println("Array-Dimensions of 'new int[][]{{1,2,3},{4,5,6}}': " + MathUtils.getArrayDimensions(new int[][]{{1,2,3},{4,5,6}}));
      String[][][] s = new String[3][4][];
      System.out.println("Array-Dimensions of 'new String[3][4][]': " + MathUtils.getArrayDimensions(s));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
