 ...
 */
/*--------------------------------------------------------------------*/
public class GraphBoostMinerGraphs extends MinerAbs implements Runnable {
	...
	public GraphBoostMinerGraphs() { /* --- create a substructure finder */
...
/*			Graph ng = (Graph) graph.clone();
	...
	public static void main(String args[]) { /* --- main function */
		...
		GraphBoostMinerGraphs miner = new GraphBoostMinerGraphs(); /* substructure miner */
...
/*			miner.init(args);  initialize the miner, 
	...
	/*		for(int i = 0; i<graphs.size(); i++){
			...
			miner = new GraphBoostMinerGraphs();
